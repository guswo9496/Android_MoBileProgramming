package com.example.nooyahs.mylocationlogger;
...
public class MainActivity extends ActionBarActivity implements
    ...
    private List lonList = new ArrayList();
...
//        bundle.putParcelableArrayList("list", locationList );
    ...
    private void updateUI() {
        String TAG = "UPDATED INFORMATION";
        ...
        locationLatLng = new LatLng(mCurrentLocation.getLatitude(), mCurrentLocation.getLongitude());

        locationList.add(locationLatLng);
        Log.d(TAG, Objects.toString(locationList));
